...
function Tabla_mantenimientos_obligatorios({ mantenimientos, buscar_mantenimientos, eliminar_mantenimiento }) {
...
export default Tabla_mantenimientos_obligatorios
